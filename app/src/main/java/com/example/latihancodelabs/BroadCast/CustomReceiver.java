package com.example.latihancodelabs.BroadCast;
...
import com.example.latihancodelabs.BuildConfig;
...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intentAction != null) {
            String toastMessage = context.getString(R.string.unknow_action);
            switch (intentAction) {
